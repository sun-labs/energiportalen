...
While we recommend to use experimental proposals with some caution, Facebook heavily uses these features in the product code, so we intend to provide [co***REMOVED***ds](https://medium.com/@cpojer/effective-javascript-co***REMOVED***ds-5a6686bb46fb) if any of these proposals change in the future.
...
First, you need to have environment variables defined. For example, let’s say you wanted to consume a ***REMOVED*** defined
...
* If the specification changes, we won’t be able to write a co***REMOVED***d because we don’t use them internally at Facebook.
...
You can find the companion GitHub repository [here](https://github.com/fullstackreact/food-lookup-***REMOVED***).

### Ruby on Rails

Check out [this tutorial](https://www.fullstackreact.com/articles/how-to-get-create-react-app-to-work-with-your-rails-api/).
You can find the companion GitHub repository [here](https://github.com/fullstackreact/food-lookup-***REMOVED***-rails).
